...
const announcementLinkTextInput = document.getElementById('announcement-link-text');
const announcementLinkUrlInput = document.getElementById('announcement-link-url');
